...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('village_postattachment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('post', self.gf('django.db.models.fields.related.ForeignKey')(related_name='attachments', to=orm['village.Post'])),
            ('attachment', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
        ))
        db.send_create_signal('village', ['PostAttachment'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('village_postattachment')
    ...
    models = {
        ...
        'village.bulkpost': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 9, 0, 0)'}),
        ...
        'village.postattachment': {
            'Meta': {'object_name': 'PostAttachment'},
            'attachment': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'post': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'attachments'", 'to': "orm['village.Post']"})
        }
    }
