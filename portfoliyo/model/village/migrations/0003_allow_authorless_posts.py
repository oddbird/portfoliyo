...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('village_post', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['users.Profile']))

    def backwards(self, orm):

        # Changing field 'Post.author'
        db.alter_column('village_post', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['users.Profile']))
    ...
    models = {
        ...
        'village.post': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 24, 0, 0)'}),
