...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.relationship'
        db.add_column('village_post', 'relationship',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='posts', null=True, to=orm['users.Relationship']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.relationship'
        db.delete_column('village_post', 'relationship_id')
    ...
    models = {
        ...
        'village.bulkpost': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 24, 0, 0)'}),
        ...
        'village.post': {
            ...
            'meta': ('jsonfield.fields.JSONField', [], {'default': '{}'}),
            'original_text': ('django.db.models.fields.TextField', [], {}),
            'relationship': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'posts'", 'null': 'True', 'to': "orm['users.Relationship']"}),
