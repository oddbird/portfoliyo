...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('village_post', 'post_type',
                      self.gf('django.db.models.fields.CharField')(default='message', max_length=20),
                      keep_default=False)

        # Adding field 'Post.attachment'
        db.add_column('village_post', 'attachment',
                      self.gf('django.db.models.fields.files.FileField')(default='', max_length=100, blank=True),
                      keep_default=False)


        # Changing field 'Post.relationship'
        db.alter_column('village_post', 'relationship_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['users.Relationship']))

    def backwards(self, orm):
        # Deleting field 'Post.post_type'
        db.delete_column('village_post', 'post_type')

        # Deleting field 'Post.attachment'
        db.delete_column('village_post', 'attachment')


        # Changing field 'Post.relationship'
        db.alter_column('village_post', 'relationship_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['users.Relationship']))
    ...
    models = {
        ...
        'users.profile': {
            ...
            'country_code': ('django.db.models.fields.CharField', [], {'default': "'us'", 'max_length': '10'}),
            ...
            'has_posted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invited_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['users.Profile']", 'null': 'True', 'blank': 'True'}),
            'lang_code': ('django.db.models.fields.CharField', [], {'default': "'en'", 'max_length': '10'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            ...
            'source_phone': ('django.db.models.fields.CharField', [], {'default': "'+15555555555'", 'max_length': '20'}),
        ...
        'village.bulkpost': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 30, 0, 0)'}),
        ...
        'village.post': {
            ...
            'meta': ('jsonfield.fields.JSONField', [], {'default': '{}'}),
            'original_text': ('django.db.models.fields.TextField', [], {}),
            'post_type': ('django.db.models.fields.CharField', [], {'default': "'message'", 'max_length': '20'}),
            'relationship': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'posts'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['users.Relationship']"}),
