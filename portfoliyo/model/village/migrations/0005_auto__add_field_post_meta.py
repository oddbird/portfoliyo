...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.meta'
        db.add_column('village_post', 'meta',
                      self.gf('jsonfield.fields.JSONField')(default={}),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.meta'
        db.delete_column('village_post', 'meta')
    ...
    models = {
        ...
        'village.post': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 26, 0, 0)'}),
