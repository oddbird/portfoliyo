...
class Migration(SchemaMigration):
    ...
    depends_on = [
        ('village', '0007_post_meta_highlights_to_sms'),
        ]

    def forwards(self, orm):
        # Deleting field 'Profile.invited_in_group'
        db.delete_column('users_profile', 'invited_in_group_id')

        # Deleting field 'Profile.state'
        db.delete_column('users_profile', 'state')


    def backwards(self, orm):
        # Adding field 'Profile.invited_in_group'
        db.add_column('users_profile', 'invited_in_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Group'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Profile.state'
        db.add_column('users_profile', 'state',
                      self.gf('django.db.models.fields.CharField')(default='done', max_length=20),
                      keep_default=False)
