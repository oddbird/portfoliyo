...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        """Populate pyo_phone of every parent-student relationship."""
        for rel in orm.Relationship.objects.filter(
            from_profile__phone__isnull=False).select_related('from_profile'):
            rel.pyo_phone = rel.from_profile.source_phone
            rel.save(force_update=True)
