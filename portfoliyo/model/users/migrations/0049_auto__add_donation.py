...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('users_donation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=255)),
            ('phone', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('school', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.School'])),
            ('country_code', self.gf('django.db.models.fields.CharField')(default='us', max_length=10)),
            ('amount', self.gf('django.db.models.fields.IntegerField')()),
            ('charge_data', self.gf('django.db.models.fields.TextField')()),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('users', ['Donation'])


    def backwards(self, orm):
        # Deleting model 'Donation'
        db.delete_table('users_donation')
    ...
    models = {
        ...
        'users.donation': {
            ...
            'charge_data': ('django.db.models.fields.TextField', [], {}),
