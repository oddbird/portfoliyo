...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Group.code'
        db.alter_column('users_group', 'code', self.gf('django.db.models.fields.CharField')(default='will-never-be-used', unique=True, max_length=20))

    def backwards(self, orm):

        # Changing field 'Group.code'
        db.alter_column('users_group', 'code', self.gf('django.db.models.fields.CharField')(unique=True, max_length=20, null=True))
