...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TextSignup'
        db.create_table('users_textsignup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('state', self.gf('django.db.models.fields.CharField')(default='kidname', max_length=20)),
            ('family', self.gf('django.db.models.fields.related.ForeignKey')(related_name='signups', to=orm['users.Profile'])),
            ('student', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='family_signups', null=True, to=orm['users.Profile'])),
            ('teacher', self.gf('django.db.models.fields.related.ForeignKey')(related_name='signed_up', to=orm['users.Profile'])),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Group'], null=True, blank=True)),
        ))
        db.send_create_signal('users', ['TextSignup'])


    def backwards(self, orm):
        # Deleting model 'TextSignup'
        db.delete_table('users_textsignup')
