...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Relationship.pyo_phone'
        db.add_column('users_relationship', 'pyo_phone',
                      self.gf('django.db.models.fields.CharField')(default='+12555555551', max_length=20),
                      keep_default=False)

        # Adding field 'TextSignup.pyo_phone'
        db.add_column('users_textsignup', 'pyo_phone',
                      self.gf('django.db.models.fields.CharField')(default='+12555555551', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Relationship.pyo_phone'
        db.delete_column('users_relationship', 'pyo_phone')

        # Deleting field 'TextSignup.pyo_phone'
        db.delete_column('users_textsignup', 'pyo_phone')
    ...
    models = {
        ...
        'users.profile': {
            ...
            'source_phone': ('django.db.models.fields.CharField', [], {'default': "'+12555555551'", 'max_length': '20'}),
        ...
        'users.relationship': {
            ...
            'pyo_phone': ('django.db.models.fields.CharField', [], {'default': "'+12555555551'", 'max_length': '20'}),
