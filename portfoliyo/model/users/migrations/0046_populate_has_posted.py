...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        orm.Profile.objects.filter(
            pk__in=orm.Profile.objects.annotate(
                numposts=models.Count('authored_posts')).filter(
                numposts__gte=1)
    ...
    models = {
        ...
        'village.bulkpost': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 25, 0, 0)'}),
