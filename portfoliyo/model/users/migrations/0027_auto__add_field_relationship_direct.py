...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Relationship.direct'
        db.add_column('users_relationship', 'direct',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding M2M table for field groups on 'Relationship'
        db.create_table('users_relationship_groups', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('relationship', models.ForeignKey(orm['users.relationship'], null=False)),
            ('group', models.ForeignKey(orm['users.group'], null=False))
        ))
        db.create_unique('users_relationship_groups', ['relationship_id', 'group_id'])


    def backwards(self, orm):
        # Deleting field 'Relationship.direct'
        db.delete_column('users_relationship', 'direct')

        # Removing M2M table for field groups on 'Relationship'
        db.delete_table('users_relationship_groups')
    ...
    models = {
        ...
        'users.relationship': {
            ...
            'from_group': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'relationships_old'", 'null': 'True', 'to': "orm['users.Group']"}),
