...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.country_code'
        db.add_column('users_profile', 'country_code',
                      self.gf('django.db.models.fields.CharField')(default='us', max_length=10),
                      keep_default=False)

        # Adding field 'Profile.source_phone'
        db.add_column('users_profile', 'source_phone',
                      self.gf('django.db.models.fields.CharField')(default='+15555555555', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.country_code'
        db.delete_column('users_profile', 'country_code')

        # Deleting field 'Profile.source_phone'
        db.delete_column('users_profile', 'source_phone')
