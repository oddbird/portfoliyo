...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Relationship.from_group'
        db.delete_column('users_relationship', 'from_group_id')


    def backwards(self, orm):
        # Adding field 'Relationship.from_group'
        db.add_column('users_relationship', 'from_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='relationships_old', null=True, to=orm['users.Group'], blank=True),
                      keep_default=False)
