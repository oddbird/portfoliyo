...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('users_relationship', (
            ...
            ('from_profile', self.gf('django.db.models.fields.related.ForeignKey')(related_name='relationships_from', to=orm['users.Profile'])),
            ('to_profile', self.gf('django.db.models.fields.related.ForeignKey')(related_name='relationships_to', to=orm['users.Profile'])),
            ('kind', self.gf('django.db.models.fields.CharField')(default='elder', max_length=20)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
        ))
        db.send_create_signal('users', ['Relationship'])

        # Adding unique constraint on 'Relationship', fields ['from_profile', 'to_profile', 'kind']
        db.create_unique('users_relationship', ['from_profile_id', 'to_profile_id', 'kind'])


    def backwards(self, orm):
        # Removing unique constraint on 'Relationship', fields ['from_profile', 'to_profile', 'kind']
        db.delete_unique('users_relationship', ['from_profile_id', 'to_profile_id', 'kind'])
