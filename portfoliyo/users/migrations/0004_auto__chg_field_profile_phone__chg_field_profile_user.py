...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('users_profile', 'user_id', self.gf('portfoliyo.users.models.AutoOneToOneField')(to=orm['auth.User'], unique=True))

    def backwards(self, orm):

        # Changing field 'Profile.phone'
        db.alter_column('users_profile', 'phone', self.gf('django.contrib.localflavor.us.models.PhoneNumberField')(unique=True, max_length=20, null=True))
