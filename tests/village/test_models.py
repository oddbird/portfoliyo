...
from ..users import factories as uf
...
def test_unicode():
    ...
    p = PostFactory.build(original_text='foo')
...
class TestPostCreate(object):
    @mock.patch('portfoliyo.village.models.timezone.now')
    ...
    @mock.patch('portfoliyo.village.models.get_pusher')
...
class TestProcessText(object):
    @mock.patch('portfoliyo.village.models.get_highlight_names')
    @mock.patch(
        'portfoliyo.village.models.replace_highlights',
    ...
    def test_full(self):
        ...
        rel1 = uf.RelationshipFactory.create(
            ...
            from_profile__phone=None,
            description="Math Teacher")
        rel2 = uf.RelationshipFactory.create(
            to_profile=rel1.to_profile,
            from_profile__name="Max Dad",
            from_profile__user__email=None,
            from_profile__phone="+13216540987",
...
def test_get_highlight_names():
    ...
    rel2 = uf.RelationshipFactory.create(
        ...
        from_profile__phone="+13216540987",
        description="Father")
    rel3 = uf.RelationshipFactory.create(
        to_profile=rel1.to_profile,
        from_profile__name="",
        from_profile__user__email=None,
...
@mock.patch('portfoliyo.village.models.text_notification_prefix')
